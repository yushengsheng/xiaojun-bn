...
RELAY_WALLET_FILE = APP_DIR / "中转钱包.txt"
RELAY_MANUAL_EXPORT_FILE = APP_DIR / "中转钱包_待人工处理.txt"
RELAY_FAILED_EXPORT_FILE = APP_DIR / "中转钱包_失败账号.txt"
SECRET_KEY_FILE = DATA_DIR / ".secret.key"
LOG_DIR = DATA_DIR / "logs"
RELAY_SWEEP_LOG_FILE = LOG_DIR / "relay_sweep.jsonl"
